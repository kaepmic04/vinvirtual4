...
const aiFeatures = [
  ...
  {
    icon: Bot,
    title: 'KI Voice Assistent',
    description: 'Sprachgesteuerte KI-Assistenten für natürliche Interaktion mit Ihrer Website.',
  },
  {
    icon: Sparkles,
    title: 'KI Support',
    description: 'Intelligente Unterstützung und Beratung durch KI-gestützte Systeme.',
  },
];
